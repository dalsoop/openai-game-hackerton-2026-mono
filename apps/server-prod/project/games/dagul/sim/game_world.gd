...
const EquipReg = preload("res://games/dagul/sim/equipment_registry.gd")
const ArenaGeo = preload("res://games/dagul/sim/arena_geometry.gd")
const RoulBuf = preload("res://games/dagul/sim/roulette_buff.gd")
const CratePk = preload("res://games/dagul/sim/crate_pickup.gd")
const HeroMov = preload("res://games/dagul/sim/hero_movement.gd")
const ProjHit = preload("res://games/dagul/sim/projectile_hit.gd")
const DmgSys = preload("res://games/dagul/sim/damage_system.gd")
const UltAnimal = preload("res://games/dagul/sim/ultimate_animal.gd")
const UltEffect = preload("res://games/dagul/sim/ultimate_effect.gd")
const ActItem = preload("res://games/dagul/sim/active_item.gd")
const MatchLife = preload("res://games/dagul/sim/match_lifecycle.gd")
const MidTowerMod = preload("res://games/dagul/sim/mid_tower.gd")
const CpuBeh = preload("res://games/dagul/sim/cpu_behavior.gd")
const DeploySys = preload("res://games/dagul/sim/deployable_system.gd")
const SafeZone = preload("res://games/dagul/sim/safe_zone_logic.gd")
const UltSummon = preload("res://games/dagul/sim/ultimate_summon.gd")
