...
const ULT_CHARGE_PER_DAMAGE := 0.144
const ULT_CHARGE_TAKEN_RATIO := 0.6666667
const ULT_CHARGE_PER_SEC := 0.24
...
func _damage_hero_environment(target: int, amount: float, show_tick: bool, source: StringName = &"environment") -> void: dmg.damage_hero_environment(target, amount, show_tick, source)
