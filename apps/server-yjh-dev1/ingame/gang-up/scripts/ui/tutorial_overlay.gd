...
const STEPS := [
	{"key": "move", "text": tr("TUTORIAL_MOVE"), "sub": tr("TUTORIAL_MOVE_SUB")},
	{"key": "fire", "text": tr("TUTORIAL_FIRE"), "sub": tr("TUTORIAL_FIRE_SUB")},
	{"key": "dash", "text": tr("TUTORIAL_DASH"), "sub": tr("TUTORIAL_DASH_SUB")},
	{"key": "skill", "text": tr("TUTORIAL_SKILL"), "sub": tr("TUTORIAL_SKILL_SUB")},
	{"key": "done", "text": tr("TUTORIAL_DONE"), "sub": tr("TUTORIAL_DONE_SUB")},
]

const HINTS := {
	"hit": tr("TUTORIAL_HIT"),
	"down": tr("TUTORIAL_DOWN"),
	"outside_zone": tr("TUTORIAL_OUTSIDE_ZONE"),
	"ultimate_ready": tr("TUTORIAL_ULTIMATE_READY"),
}
