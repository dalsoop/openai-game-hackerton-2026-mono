...
const SLOT_COUNT := 8
var ANIMALS := [tr("THEME_ANIMAL_RABBIT"), tr("THEME_ANIMAL_RAT"), tr("THEME_ANIMAL_TIGER"), tr("THEME_ANIMAL_OX"), tr("THEME_ANIMAL_DRAGON"), tr("THEME_ANIMAL_HORSE"), tr("THEME_ANIMAL_ROOSTER"), tr("THEME_ANIMAL_PIG")]
const LOBBY_ANIMAL_FRAME := [3, 0, 2, 1, 5, 6, 9, 11]
var NICKS := [tr("THEME_NICK_RABBIT"), tr("THEME_NICK_RAT"), tr("THEME_NICK_TIGER"), tr("THEME_NICK_OX"), tr("THEME_NICK_DRAGON"), tr("THEME_NICK_HORSE"), tr("THEME_NICK_ROOSTER"), tr("THEME_NICK_PIG")]
const SLOT_COLORS := [
...
static func load_png(filename: String) -> Texture2D:
